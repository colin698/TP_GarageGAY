...
public class Voiture {
    ...
    private Set<Garage> myGarages = new HashSet<>();
    ...
    public void entreAuGarage(Garage g) throws Exception {
        ...
        if (this.estDansUnGarage()) {
            throw new UnsupportedOperationException("La voiture ne doit pas déjà être dans un garage");
        }
     ...
     * Précondition : la voiture doit être dans
     * un garage
     *
    ...
    public void sortDuGarage() throws Exception {
        ...
        if (!this.estDansUnGarage()) {
            throw new UnsupportedOperationException("La voiture doit être dans un garage avant de pouvoir en sortir");
        } else {
    ...
    public boolean estDansUnGarage() {
        ...
        if (myStationnements.get(myStationnements.size() - 1).estEnCours() == true) {
            return true;
        } else {
            return false;
        }
